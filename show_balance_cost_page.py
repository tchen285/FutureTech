...
class ShowBalanceCost:
    def __init__(self, app):
        ...
        # Initialize labels
        self.label1 = Label(self.frame, text=f"The balance process has 2 steps.", font=("Arial", 16), bg="white")
        self.label1.grid(row=0, column=0, pady=10)

        self.label2 = Label(self.frame, text="Takes 12 minutes to complete.", font=("Arial", 16), bg="white")
